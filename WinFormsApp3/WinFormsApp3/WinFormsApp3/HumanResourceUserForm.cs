...
{
    public partial class HumanResourceUserForm : Form
    {
        ...
        public HumanResourceUserForm(string username)
        {
            InitializeComponent();
        ...
        private void LoadData()
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    using (SqlCommand command = new SqlCommand("GetAllEmployeesExceptUserDepartment", connection))
                    {
        ...
        private void btnBackHumanResourseUser_Click(object sender, EventArgs e)
        {
